...
RESOURCES += src/qt/bhn.qrc src/qt/bhn_locale.qrc

TRANSLATIONS += src/qt/locale/bhn_bg.ts \
                src/qt/locale/bhn_de.ts \
                src/qt/locale/bhn_en.ts \
                src/qt/locale/bhn_es.ts \
                src/qt/locale/bhn_fi.ts \
                src/qt/locale/bhn_fr.ts \
                src/qt/locale/bhn_it.ts \
                src/qt/locale/bhn_ja.ts \
                src/qt/locale/bhn_pl.ts \
                src/qt/locale/bhn_pt.ts \
                src/qt/locale/bhn_ru.ts \
                src/qt/locale/bhn_sk.ts \
                src/qt/locale/bhn_sv.ts \
                src/qt/locale/bhn_vi.ts \
                src/qt/locale/bhn_zh_CN.ts \
                src/qt/locale/bhn_zh_TW.ts

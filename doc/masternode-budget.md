...
MCC now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mcc_address\> \<monthly_payment_mcc\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MCC, _12_ times over the course of a year totaling _24000_ MCC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mcc_address\> \<monthly_payment_mcc\> \<collateral_hash\>
...
Output: `a2b20002ae82e45a973a94309ffa6aa2e2388b8f95b39ab3739f0078835f0491` - This is your proposal hash, which other nodes will use to vote on it
...
{
    "Name" : "cool-project",
    "Hash" : "a2b20002ae82e45a973a94309ffa6aa2e2388b8f95b39ab3739f0078835f0491",
...
Example:
```
mnbudget vote a2b20002ae82e45a973a94309ffa6aa2e2388b8f95b39ab3739f0078835f0491 yes
```
...
When block `1000000` is reached you'll receive a payment for `1200` MCC.
 ...
 * vote-many          - Vote on a MCC initiative
 * vote-alias         - Vote on a MCC initiative
 * vote               - Vote on a MCC initiative/budget

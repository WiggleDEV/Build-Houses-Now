...
In order to support loading of multiple wallets in mcc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mcc.cpp.
...
Changes to mcc.cpp
----------------------
mcc.cpp is the entry point into mcc-qt, and as such, will require some minor modifications to provide hooks for

/* src/config/bhn-config.h.  Generated from bhn-config.h.in by configure.  */
/* src/config/bhn-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.BHNs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BHN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BHN Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "BHN"

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BHN features */
        {"bhn", "masternode", &masternode, true, true, false},
        {"bhn", "masternodelist", &masternodelist, true, true, false},
        {"bhn", "mnbudget", &mnbudget, true, true, false},
        {"bhn", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bhn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bhn", "mnsync", &mnsync, true, true, false},
        {"bhn", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bhnd, or the -server option to bhn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"BHN Alert\" admin@foo.com\n"),
...
{
    return "> bhn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20002/\n";
}
